...
for i = 1:sim_time
    Htsupport = @(joint_angles) getTransform(param.robot,joint_angles,'base',param.supportFoot);
    Htswing = @(joint_angles) getTransform(param.robot,joint_angles,'base',param.swingFoot);
...
%    + 0.5*trace(eye(3)-rotation(getTransform(robot,joint_angles,param.swingFoot,'base')));                        
