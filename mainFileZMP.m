...
param.support_foot = 'left_foot';
param.swingFoot = 'right_foot';
rCTt1 = plotData(opt_joint_angles_1,param,foot_traj_1);
% Plot 2nd step
param.support_foot = 'right_foot';
param.swingFoot = 'left_foot';
rCTt2 =plotData(opt_joint_angles_2,param,foot_traj_2);
% Plot 3rd step
param.support_foot = 'left_foot';
param.swingFoot = 'right_foot';
rCTt3 = plotData(opt_joint_angles_3,param,foot_traj_3);
